...
SECRET_KEY = 'r2hq2v0h(-8gob%ojcxn=8$c$kp*$tex%3a4#!y032wl!yhgu%'
...
ADMINS = (
    ('adit sadi', 'adit.fitternity@email.com'),
)
MANAGERS = ADMINS
...
STATIC_URL = '/static/'
LOGOUT_REDIRECT_URL='/music/register/'
